    ...
    for(let j=0;j<responses.length;j++){
        ...
        if(responses[j].questionresponse){
            for(let k=0;k<responses[j].questionresponse.length;k++){
                responses[j].questionresponse[k] = responses[j].questionresponse[k].trim();
            }
        }
        if(!responses[j].questionresponse || responses[j].questionresponse.length == 0 || responses[j].questionresponse == ""){
